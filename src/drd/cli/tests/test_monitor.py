...
class TestMonitor(unittest.TestCase):
    ...
    # @patch('src.drd.cli.monitor.call_harsh_api')
    # def test_handle_module_not_found(self, mock_call_harsh_api):
    #     monitor = MagicMock()
    #     line = "Error: Cannot find module 'missing-module'"
    #     handle_module_not_found(line, monitor)
    #     mock_call_harsh_api.assert_called_once()

    # @patch('src.drd.cli.monitor.call_harsh_api')
    # def test_handle_port_in_use(self, mock_call_harsh_api):
    #     monitor = MagicMock()
