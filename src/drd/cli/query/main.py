import click
from ...api.harsh_api import stream_harsh_api, call_harsh_vision_api
from ...api.harsh_parser import pretty_print_commands
from ...utils.step_executor import Executor
from ...metadata.project_metadata import ProjectMetadataManager
from ...prompts.error_handling import handle_error_with_harsh
...
def execute_harsh_command(query, image_path, debug, instruction_prompt):
    print_info("Starting harsh CLI tool..")
    ...
    try:
        ...
        if image_path:
            ...
            commands = []
            for new_commands in stream_harsh_api(full_query, include_context=True, instruction_prompt=instruction_prompt):
            ...
            for attempt in range(max_retries):
                if cmd['type'] == 'metadata':
                    ...
                    if isinstance(result, tuple) and not result[0]:
                        ...
                        if handle_error_with_harsh(error, cmd, executor, metadata_manager):
                            print_info(
        ...
        print_success("harsh CLI tool execution completed.")
