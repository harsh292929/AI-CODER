...
from .commands import harsh_cli_logic
...
def harsh_cli(query, image, debug, hot_fix, meta_add, meta_init, ask, file, version, command):
    harsh_cli_logic(query, image, debug, hot_fix,
