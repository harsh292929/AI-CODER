import unittest
from src.drd.api.harsh_parser import extract_and_parse_xml, parse_harsh_response


class TestharshParser(unittest.TestCase):
    ...
    def test_parse_harsh_response(self):
        response = """
        <response>
        ...
        """
        commands = parse_harsh_response(response)
